...
namespace Proiect1.DAL.Migrations
{
    ...
    [Migration("20230212133749_BookCollectionConfig")]
    partial class BookCollectionConfig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proiect1.DAL.Entities.BookAward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proiect1.DAL.Entities.BookCollection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proiect1.DAL.Entities.BookReaders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proiect1.DAL.Entities.ReaderAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proiect1.DAL.Entities.BookReaders", b =>
                {
                    ...
                    b.HasOne("Proiect1.DAL.Entities.Reader", "Reader")
                        .WithMany("BookReaders")
            ...
            modelBuilder.Entity("Proiect1.DAL.Entities.ReaderAddress", b =>
                {
                    b.HasOne("Proiect1.DAL.Entities.Reader", "Reader")
                        ...
                        .HasForeignKey("Proiect1.DAL.Entities.ReaderAddress", "ReaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
